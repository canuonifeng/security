...
@ExpectedDatabase(value = "courseArrangeService.data.xml", assertionMode = DatabaseAssertionMode.NON_STRICT)
public class CourseArrangeServiceTest extends BaseServiceTest {
	...
	public void testCreateClassSchedule() {
		...
		classSchedule.setId(2L);
		classSchedule.setTerm("17-18-2");
